...
static const std::map<int, const char*> newLicenseeCodes = {
    {0x00, "None" },
	...
	{0x70, "Infogrames"},
	{0x71, "Interplay Entertainmen"},
	{0x72, "Broderbund"},
	{0x73, "Sculptured Software"},
	{0x75, "The Sales Curve Limite"},
	{0x78, "THQ"},
	{0x79, "Accolade"},
...
static const std::map<int, const char*> oldLicenseeCodes = {
	{0x00,	"None"},
	{0x01,	"Nintendo"},
	{0x08,	"Capcom"},
	{0x09,	"HOT - B"},
...
class Cartridge
{
	struct RomHeader {
		...
		char title[16];
		//unsigned char manufacturerCode[4];
